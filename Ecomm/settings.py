...
SECRET_KEY = 'django-insecure-7_w!^#u(f%f(0i-0y21^2v*-p=d%1y6zw+72+207y))9pst(%@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'product.context_processor.all_categories',
                'product.context_processor.wishlist_count',
                'cart.contex_processor.counter'
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'pythondev65@gmail.com'
EMAIL_HOST_PASSWORD = 'rtglkpotjudfoyzb'
